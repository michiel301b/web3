...
document.getElementsByClassName("gold-text")[0].textContent = `${Math.floor(displaydata.gold)} Gold 🪙`
document.getElementsByClassName("xp-text")[0].textContent = `${Math.floor(displaydata.xp)} XP ⭐`
document.getElementsByClassName("level-text")[0].textContent = `Level: ${Math.floor(displaydata.level)} 🚀`
